...
# give me a long description for a READ-ME file
...
class LoginScreen(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        register_button = ttk.Button(self, text='Register', command=lambda: self.controller.show_frame(RegisterScreen))
...
class RegisterScreen(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        back_button = ttk.Button(self, text='Back', command=lambda: self.controller.show_frame(LoginScreen))
